...
class UNetSuperRes(nn.Module):
    """
    U-Net architecture for MRI super-resolution.
    This model is particularly effective for medical imaging tasks.
    """
    def __init__(self, n_channels=1, n_classes=1, bilinear=True, base_filters=64):
        ...
        # Skip connection from input to output for residual learning
        self.skip = True
